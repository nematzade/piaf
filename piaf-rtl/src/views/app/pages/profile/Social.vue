              ...
              <b-card class="mb-4" no-body>
                <b-card-body>
                  <div class="text-center pt-4">
                    <p class="list-item-heading pt-2">مطهره تقوی</p>
                  </div>
                  <p
                    class="mb-3"
                  >سلام. من یه برنامه نویس هستم. این قسمت هم درباره ی بیوگرافی منه
من هیچوقت منتظر نمیشم که ستاره هام توی یک ردیف قرار بگیرن و سرنوشتمو بسازن، بلکه خودم ستاره هامو میچینم🌜</p>
                  <p class="text-muted text-small mb-2">{{$t('pages.location')}}</p>
                  <p class="mb-3">ایران</p>
                  <p class="text-muted text-small mb-2">{{$t('pages.responsibilities')}}</p>
                  <p class="mb-3">
                    <b-badge variant="outline-secondary" class="mb-1 mr-1" pill>فرانت اند</b-badge>
                    <b-badge variant="outline-secondary" class="mb-1 mr-1" pill>جاوااسکریپت</b-badge>
                    <b-badge variant="outline-secondary" class="mb-1 mr-1" pill>ری اکت</b-badge>
                    <b-badge variant="outline-secondary" class="mb-1 mr-1" pill>طراحی گرافیک</b-badge>
                  </p>
