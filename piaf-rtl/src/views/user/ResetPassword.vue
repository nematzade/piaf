          ...
          <b-form @submit.prevent="formSubmit" class="av-tooltip tooltip-label-bottom">
            <b-form-group :label="$t('user.password')" class="has-float-label mb-4">
              ...
              <b-form-invalid-feedback v-if="!$v.form.password.required"
                >لطفا رمز عبور را وارد کنید</b-form-invalid-feedback
              >
              <b-form-invalid-feedback
                v-else-if="!$v.form.password.minLength || !$v.form.password.maxLength"
                >رمز عبور شما باید بین 4 تا 16 کاراکتر داشته باشد</b-form-invalid-feedback
              >
            </b-form-group>
            <b-form-group :label="$t('user.password-again')" class="has-float-label mb-4">
              ...
              <b-form-invalid-feedback v-if="!$v.form.passwordAgain.required"
                >لطفا دوباره رمز عبور را وارد کنید</b-form-invalid-feedback
              >
              <b-form-invalid-feedback v-else-if="!$v.form.passwordAgain.sameAsPassword"
                >ورودی های شما درست نیستند</b-form-invalid-feedback
              >
            </b-form-group>
