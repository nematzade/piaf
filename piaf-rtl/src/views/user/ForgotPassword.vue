    ...
    <b-colxx xxs="12" md="10" class="mx-auto my-auto">
      <b-card class="auth-card" no-body>
        <div class="position-relative image-side">
          ...
          <p class="white mb-0">
            از ایمیل می تونی برای پیدا کردن رمز عبورت استفاده کنی
          ...
          <b-form @submit.prevent="formSubmit" class="av-tooltip tooltip-label-bottom">
            <b-form-group :label="$t('user.email')" class="has-float-label mb-4">
              ...
              <b-form-invalid-feedback v-if="!$v.form.email.required"
                >لطفا ایمیل رو وارد کنید</b-form-invalid-feedback
              >
              <b-form-invalid-feedback v-else-if="!$v.form.email.email"
                >لطفا یک ایمیل معتبر وارد کنید</b-form-invalid-feedback
              >
              <b-form-invalid-feedback v-else-if="!$v.form.email.minLength"
                >ایمیل شما باید حداقل 4 کاراکتر باشد</b-form-invalid-feedback
              >
            </b-form-group>
