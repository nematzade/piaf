...
<b-row>
    <b-colxx xxs="12">
        <b-card class="mb-4" title="مقادیر دلخواه">
            <b-form @submit.prevent="onValitadeFormSubmit" class="av-tooltip tooltip-label-right">
                ...
                <b-form-group label="تکرار پست الکترونیک" class="error-l-100">
                ...
                <b-form-group label="شماره" class="error-l-100">
