...
<b-row>
    <b-colxx xxs="12">
        <b-card class="mb-4">
            <h6 class="mb-4">لوکیشن ها</h6>
            <b-form @submit.prevent="onValitadeFormSubmit" class="av-tooltip mb-5">
                <b-form-group class="error-l-100 tooltip-label-right" label="لیبل راست">
                    <b-form-input type="text" v-model.trim="labelright" :state="!$v.labelright.$invalid" />
                    <b-form-invalid-feedback>لیبل راست!</b-form-invalid-feedback>
                </b-form-group>
                <b-form-group class="tooltip-center-top" label="بالا وسط">
                    <b-form-input type="text" v-model.trim="topcenter" :state="!$v.topcenter.$invalid" />
                    <b-form-invalid-feedback>بالا وسط!</b-form-invalid-feedback>
                </b-form-group>
                <b-form-group class="tooltip-right-top" label="بالا راست">
                    <b-form-input type="text" v-model.trim="topright" :state="!$v.topright.$invalid" />
                    <b-form-invalid-feedback>بالا راست!</b-form-invalid-feedback>
                </b-form-group>
                <b-form-group class="tooltip-left-top" label="بالا چپ">
                    <b-form-input type="text" v-model.trim="topleft" :state="!$v.topright.$invalid" />
                    <b-form-invalid-feedback>بالا چپ!</b-form-invalid-feedback>
                </b-form-group>

                <b-form-group class="tooltip-center-bottom" label="پایین وسط">
                    <b-form-input type="text" v-model.trim="bottomcenter" :state="!$v.bottomcenter.$invalid" />
                    <b-form-invalid-feedback>پایین وسط!</b-form-invalid-feedback>
                </b-form-group>
                <b-form-group class="tooltip-right-bottom" label="پایین راست">
                    <b-form-input type="text" v-model.trim="bottomright" :state="!$v.bottomright.$invalid" />
                    <b-form-invalid-feedback>پایین راست!</b-form-invalid-feedback>
                </b-form-group>
                <b-form-group class="tooltip-left-bottom" label="پایین چپ">
                    <b-form-input type="text" v-model.trim="bottomleft" :state="!$v.topright.$invalid" />
                    <b-form-invalid-feedback>پایین چپ!</b-form-invalid-feedback>
                </b-form-group>

                <b-button type="submit" variant="primary" class="mt-4" >{{ $t('forms.submit') }}</b-button>
            </b-form>

            <h6 class="mb-4">لوکیشن و قرارگیری لیبل ها</h6>
