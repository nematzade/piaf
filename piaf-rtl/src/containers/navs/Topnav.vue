  ...
  <nav class="navbar fixed-top">
    <div class="d-flex align-items-center navbar-left">
      ...
      <div class="position-relative d-none d-none d-lg-inline-block">
        <a class="btn btn-outline-primary btn-sm ml-2" target="_top" :href="buyUrl">{{
          $t("user.buy")
        }}</a>
      </div>
    </div>
    ...
    <div class="navbar-right">
      ...
      <div class="user d-inline-block">
        ...
        >
          ...
          <b-dropdown-item>حساب کاربری</b-dropdown-item>
          <b-dropdown-item>ویژگی ها</b-dropdown-item>
          <b-dropdown-item>آرشیو</b-dropdown-item>
          <b-dropdown-item>پشتیبانی</b-dropdown-item>
          <b-dropdown-divider />
