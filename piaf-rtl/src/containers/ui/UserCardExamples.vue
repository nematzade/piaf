        ...
        <b-colxx md="6" sm="6" lg="4" xxs="12">
          <b-card class="mb-4 text-center">
            <router-link to="?">
              ...
              />
              <h6 class="mb-1 card-subtitle">فاطمه کاظمی</h6>
              <p class="text-muted text-small mb-4">مدیر اجرایی</p>
            </router-link>
            <b-button size="sm" variant="outline-primary">ویرایش</b-button>
          </b-card>
        </b-colxx>
            ...
            <div class="d-flex flex-grow-1 min-width-zero">
              ...
              >
                <div class="min-width-zero">
                  <router-link to="?">
                    <h6 class="mb-1 card-subtitle truncate">فاطمه کاظمی</h6>
                  </router-link>
                  <p class="text-muted text-small mb-2">مدیر اجرایی</p>
                  <b-button size="xs" variant="outline-primary">ویرایش</b-button>
                </div>
              </div>
            </div>
          </b-card>
