            ...
            <div class="pl-2 d-flex flex-grow-1 min-width-zero">
              ...
              >
                <router-link to="?" class="w-40 w-sm-100">
                  <p class="list-item-heading mb-1 truncate">کیک شکلاتی</p>
                </router-link>
                <p class="mb-1 text-muted text-small w-15 w-sm-100">کیک ها</p>
                <p class="mb-1 text-muted text-small w-15 w-sm-100">4 مرداد 1400</p>
                <div class="w-15 w-sm-100">
                  <b-badge variant="primary" pill>در حال پردازش</b-badge>
                </div>
              </div>
        ...
        <b-colxx xxs="12" class="mb-3">
          <b-card class="d-flex flex-row mb-4" no-body>
            ...
            <div class="pl-2 d-flex flex-grow-1 min-width-zero">
              ...
              >
                <router-link to="?" class="w-40 w-sm-100">
                  <p class="list-item-heading mb-1 truncate">چیز کیک</p>
                </router-link>
                <p class="mb-1 text-muted text-small w-15 w-sm-100">کاپ کیک</p>
                <p class="mb-1 text-muted text-small w-15 w-sm-100">4 مرداد 1400</p>
                <div class="w-15 w-sm-100">
                  <b-badge variant="secondary" pill>در انتظار</b-badge>
                </div>
              </div>
              <div class="custom-control custom-checkbox pl-1 align-self-center pr-4">
                <div class="custom-control custom-checkbox mb-0">
